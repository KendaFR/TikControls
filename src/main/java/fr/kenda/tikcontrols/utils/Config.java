...
public class Config {
    private static final TikControls INSTANCE = TikControls.getInstance();
    ...
    public static float getFloat(String path) {
        return (float) INSTANCE.getConfig().get(path);
    }
    ...
    public static double getDouble(String path) {
        return (double) INSTANCE.getConfig().get(path);
    }
    ...
    public static long getLong(String s) {
        return (long) CONFIG.getDouble(s);
    }

    public static boolean isConfigSectionExist(String path) {
